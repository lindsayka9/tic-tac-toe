...
var fullGameBoard = function fullGameBoard(board) {
...
var onShowGameOver = function onShowGameOver(event) {
  event.preventDefault();
  api.showGameOver().then(ui.showGameOverSuccess).catch(ui.showGameOverFailure);
};
...
var showGameOverSuccess = function showGameOverSuccess(data) {
  store.stats = data;
  $('#message').text('You have finished ' + store.stats.games.length + ' games');
};

var showGameOverFailure = function showGameOverFailure(error) {
  console.error(error);
};
...
module.exports = {
  ...
  showGameOverSuccess: showGameOverSuccess,
  showGameOverFailure: showGameOverFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var showGameOver = function showGameOver(data) {
  return $.ajax({
